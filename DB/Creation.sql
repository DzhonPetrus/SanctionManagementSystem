DROP DATABASE IF EXISTS  SANCTION_MANAGEMENT;
...
CREATE TABLE SANCTION(
    ...
    _Description TINYTEXT NOT NULL,
    FOREIGN KEY(TypeID)  REFERENCES SANCTIONTYPE(TypeID) ON UPDATE CASCADE
);
...
CREATE TABLE SANCTIONLOG(
    ...
    FOREIGN KEY(SanctionCode) REFERENCES SANCTION(SanctionCode) ON UPDATE CASCADE
);
...
CREATE TABLE SERVICE(
    ...
    FOREIGN KEY(LogID) REFERENCES SANCTIONLOG(LogID) ON UPDATE CASCADE
);
